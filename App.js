...
//import JaneData from './components/data/jane_posts.json';
    ...
    render () {
      return (
          <div className="page-display">
              ...
              {/**
               * TODO
               * Render the StockTicker and Date components. You can use the date 
               * component twice for both the start and end dates.
